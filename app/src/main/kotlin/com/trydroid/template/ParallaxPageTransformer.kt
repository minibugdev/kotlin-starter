...
class ParallaxPageTransformer : ViewPager.PageTransformer {
    override fun transformPage(page: View, position: Float) {
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            val title = page.findViewById(R.id.title)
            ...
            val description = page.findViewById(R.id.description)
            ...
            val customIcon = page.findViewById(R.id.customIcon)
            ...
            // isn't null.
            if (pagePosition == 0 && customIcon != null) {
                customIcon.alpha = 1.0f - absPosition
                customIcon.translationX = -pageWidthTimesPosition * 1.5f
            }
